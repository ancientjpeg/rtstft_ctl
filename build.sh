...
<installer-gui-script>
    ...
    <choice id="pick0" title="Audio Unit" description="rtstft_ctl Audio Unit Installation">
        <pkg-ref id="com.soundctl.rtstftctl.au"/>
    </choice>
    <choice id="pick1" title="VST3" description="rtstft_ctl VST3 Installation">
        <pkg-ref id="com.soundctl.rtstftctl.vst3"/>
    </choice>
    <pkg-ref id="com.soundctl.rtstftctl.au" version="0.1.0" auth="Root">rtstft_ctl.component.pkg</pkg-ref>
	<pkg-ref id="com.soundctl.rtstftctl.vst3" version="0.1.0" auth="Root">rtstft_ctl.vst3.pkg</pkg-ref>
</installer-gui-script>
XMLEND
