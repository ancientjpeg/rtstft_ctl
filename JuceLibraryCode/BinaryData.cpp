...
"Built with:\n"
"\n"
"    clang -o test_pffft -DHAVE_MKL -I /opt/intel/mkl/include -DHAVE_FFTW -DHAVE_VECLIB -O3 -Wall -W pffft.c test_pffft.c fftpack.c -L/usr/local/lib -I/usr/local/include/ -lfftw3f -framework Accelerate /opt/intel/mkl/lib/libmkl_{intel_lp64,sequential,"
"core}.\n"
"\n"
...
const char* getNamedResource (const char* resourceNameUTF8, int& numBytes)
{
    ...
    switch (hash)
    {
        case 0x64791dc8:  numBytes = 22901; return README_md;
        default: break;
    }
